...
Soy un apasionado desarrollador con interés en crear soluciones innovadoras que impacten positivamente. Actualmente curso **Ingeniería de Software** y busco oportunidades para aplicar mis conocimientos en proyectos desafiantes.
...
![Estadísticas de GitHub](https://github-readme-stats.vercel.app/api?usernameFelixElMenor&show_icons=true&theme=radical&hide_border=true)
...
```mermaid
graph LR
    A[Fundamentos Web] --> B[JavaScript ES6+]
    B --> C[Frameworks Frontend]
    B --> D[Node.js Backend]
    C --> E[React Avanzado]
    D --> F[APIs y Bases de datos]
    E --> G[Aplicaciones Full Stack]
    F --> G
    G --> H[DevOps y Cloud]
